...
public class TestsVoiture
{
    ...
    [Fact]
    public void Initialiser_CasMarqueVide_Exception()
    {
        // Arranger
        string marque = "";
        string modele = "modele1";
    ...
    [Fact]
    public void Initialiser_CasModeleeVide_Exception()
    {
        // Arranger
        string marque = "marque1";
        string modele = "";
    ...
    [Fact]
    public void Initialiser_CasMarqueEspaces_Exception()
    {
        // Arranger
        string marque = "   ";
        string modele = "modele1";
    ...
    [Fact]
    public void Initialiser_CasModeleeEspace_Exception()
    {
        // Arranger
        string marque = "marque1";
        string modele = "    ";
